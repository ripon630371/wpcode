...
function eduker_scripts() {
    ...
    */
    ...
    wp_enqueue_style( 'eduker-fonts', eduker_fonts_url(), array(), '1.0.0' );
    if( is_rtl() ){
    ...
    wp_enqueue_style( 'backtotop', EDUKER_THEME_CSS_DIR . 'backtotop.css', [] );
    ...
    wp_enqueue_style( 'font-awesome-pro', EDUKER_THEME_CSS_DIR . 'font-awesome-pro.css', [] );
    ...
    wp_enqueue_script( 'backtotop', EDUKER_THEME_JS_DIR . 'backtotop.js', [ 'jquery' ], '', true );
