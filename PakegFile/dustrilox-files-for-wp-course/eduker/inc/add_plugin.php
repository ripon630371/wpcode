...
function eduker_register_required_plugins() {
    ...
    $plugins = [
        ...
        [
            ...
            'slug'         => 'tp-core',
            'source'       => esc_url( 'https://themepure.net/wp/eduker/source/tp-core.zip' ),
            'required'     => true,
            'external_url' => esc_url( 'https://themepure.net/wp/eduker/source/tp-core.zip' ),
        ],
        [
            'name'         => esc_html__( 'Advanced Custom Fields Pro', 'eduker' ),
            'slug'         => 'advanced-custom-fields-pro',
            'source'       => esc_url( 'https://themepure.net/wp/eduker/source/advanced-custom-fields-pro.zip' ),
            'required'     => true,
            'external_url' => esc_url( 'https://themepure.net/wp/eduker/source/advanced-custom-fields-pro.zip' ),
        ],
        [
        ...
        [
            'name'     => esc_html__( 'Mailchimp For WP', 'eduker' ),
