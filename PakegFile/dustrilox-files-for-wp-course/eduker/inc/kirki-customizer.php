...
function eduker_customizer_panels_sections( $wp_customize ) {
    ...
    $wp_customize->add_section( 'slug_setting', [
        'title'       => esc_html__( 'Slug Settings', 'eduker' ),
        'description' => '',
        'priority'    => 22,
        'capability'  => 'edit_theme_options',
        'panel'       => 'eduker_customizer',
...
function _header_side_fields( $fields ) {
    ...
    $fields[] = [
        ...
        'section'  => 'header_side_setting',
        'default'  => esc_html__( 'info@themepure.net', 'eduker' ),
        'priority' => 10,
    ];
    return $fields;
}
 ...
 * Added Fields
 */
function eduker_slug_setting( $fields ) {
    // slug settings
    $fields[] = [
        'type'     => 'text',
        'settings' => 'eduker_ev_slug',
        'label'    => esc_html__( 'Event Slug', 'eduker' ),
        'section'  => 'slug_setting',
        'default'  => esc_html__( 'ourevent', 'eduker' ),
        'priority' => 10,
    ];

    $fields[] = [
        'type'     => 'text',
        'settings' => 'eduker_port_slug',
        'label'    => esc_html__( 'Portfolio Slug', 'eduker' ),
        'section'  => 'slug_setting',
        'default'  => esc_html__( 'ourportfolio', 'eduker' ),
        'priority' => 10,
    ];
...
add_filter( 'kirki/fields', 'eduker_slug_setting' );
