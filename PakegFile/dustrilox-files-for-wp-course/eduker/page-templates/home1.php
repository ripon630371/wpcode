                           ...
                           <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                              <div class="slider__content p-relative z-index-1">
                                 ...
                                 <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                                    <a href="https://themepure.net/wp/eduker/course-style-01/" class="tp-btn">Find Courses</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                        ...
                        <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="https://themepure.net/wp/eduker/about/">Graduation</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>

                              <a href="https://themepure.net/wp/eduker/about/" class="link-btn">Learn More <i class="fa-regular fa-arrow-right"></i></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="https://themepure.net/wp/eduker/about/">University Life</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>
                     ...
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="features__item d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="https://themepure.net/wp/eduker/about/">Education Services</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-5">
                     <div class="about__content pl-70 pr-25">
                        ...
                        <div class="about__btn">
                           <a href="https://themepure.net/wp/eduker/about/" class="tp-btn tp-btn-2">Read more</a>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">University seminar series global.</a>
                           </h3>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">Web coding and apache basics</a>
                           </h3>
                           <p>A beginner’s guide to designing or renovating interior spaces that pop.</p>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">Economics historical development</a>
                           </h3>
                           <p>A beginner’s guide to designing or renovating interior spaces that pop.</p>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">Learn algebra the easy way!</a>
                           </h3>
                           <p>A beginner’s guide to designing or renovating interior spaces that pop.</p>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">Angular the complete guide</a>
                           </h3>
                           <p>A beginner’s guide to designing or renovating interior spaces that pop.</p>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                           ...
                           <h3 class="course__title">
                              <a href="https://themepure.net/wp/eduker/course-details/">Intelligence analyst course 2022</a>
                           </h3>
                           <p>A beginner’s guide to designing or renovating interior spaces that pop.</p>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
                     <div class="campus__wrapper">
                        ...
                        <div class="campus__btn mb-80">
                           <a href="https://themepure.net/wp/eduker/about/" class="tp-btn tp-btn-border">More Research</a>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="blog__item-float blog__item-float-overlay p-relative fix transition-3 mb-30 d-flex align-items-end">
                        ...
                        <div class="blog__content-float">
                           ...
                           <h3 class="blog__title-float">
                              <a href="https://themepure.net/wp/eduker/growing-ux-maturity-in-organizations-education-and-training/">Individual master Courses For degree students.</a>
                           </h3>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                     <div class="blog__item mb-30 white-bg transition-3 mb-30">
                        <div class="blog__thumb w-img fix">
                           <a href="https://themepure.net/wp/eduker/growing-ux-maturity-in-organizations-education-and-training/">
                        ...
                        <div class="blog__content">
                           ...
                           <h3 class="blog__title">
                              <a href="https://themepure.net/wp/eduker/growing-ux-maturity-in-organizations-education-and-training/">How stay calm from the First time.</a>
                           </h3>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                     <div class="blog__item mb-30 white-bg transition-3 mb-30">
                        ...
                        <div class="blog__content">
                           ...
                           <h3 class="blog__title">
                              <a href="https://themepure.net/wp/eduker/growing-ux-maturity-in-organizations-education-and-training/">Classroom adapts for the future of learning</a>
                           </h3>
                           <div class="blog__meta">
                              <ul>
                                 <li>
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                           ...
                           <div class="cta__content">
                              ...
                              <a href="https://themepure.net/wp/eduker/contact/" class="tp-btn tp-btn-3">Start Teaching</a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                           ...
                           <div class="cta__content">
                              ...
                              <a href="https://themepure.net/wp/eduker/contact/" class="tp-btn tp-btn-4">Apply Now</a>
                           </div>
                        </div>
                     </div>
                  </div>
